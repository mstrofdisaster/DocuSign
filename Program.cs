        ...
        public static string CreatePersonalizedForm(Student s, int pdfFormId)
        {
               ...
               switch (pdfFormId)
            {
                case 1:
                    ...
                    outputForm = @"C:\Docusign\Output_Forms\StudentClerkshipEvaluationForm_" + s.StudentId + ".pdf";
                    break;
                case 2:
                    currentForm = @"C:\Docusign\AUA_Forms\StudentFacultyEvaluationForm.pdf";
                    outputForm = @"C:\Docusign\Output_Forms\StudentFacultyEvaluationForm_" + s.StudentId + ".pdf";
                    break;
                case 3:
                    currentForm = @"C:\Docusign\AUA_Forms\MidClerkshipAssessmentForm.pdf";
                    outputForm = @"C:\Docusign\Output_Forms\MidClerkshipAssessmentForm_" + s.StudentId + ".pdf";
                    break;
                case 4:
                    currentForm = @"C:\Docusign\AUA_Forms\StudentPortfolioForm.pdf";
                    outputForm = @"C:\Docusign\Output_Forms\StudentPortfolioForm_" + s.StudentId + ".pdf";
                    break;
                case 5:
                    currentForm = @"C:\Docusign\AUA_Forms\ComprehensiveStudentClerkshipAssessmentForm.pdf";
                    outputForm = @"C:\Docusign\Output_Forms\ComprehensiveStudentClerkshipAssessmentForm_" + s.StudentId + ".pdf";
                    break;
